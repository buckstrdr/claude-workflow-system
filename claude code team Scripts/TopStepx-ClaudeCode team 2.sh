#!/bin/bash
# Simplified Claude Code Launcher - Team 2
...
xterm -xrm 'XTerm.vt100.allowTitleOps: false' -T "CC-TSX-DEV - Team 2" -e bash -c "
    ...
    echo -ne '\033]0;CC-TSX-DEV - Team 2\007'
    PROMPT_COMMAND='printf \"\033]0;CC-TSX-DEV - Team 2\007\"'
    ...
    clear
    echo '══════════════════════════════════════════════════════'
    echo '  Claude Code Session - Team 2'
    echo '══════════════════════════════════════════════════════'
    echo ''
    echo \"  Project: \$(pwd)\"
    echo ''
