#!/bin/bash
# Simplified Claude Code Launcher - Team 1
...
xterm -xrm 'XTerm.vt100.allowTitleOps: false' -T "CC-TSX-DEV - Team 1" -e bash -c "
    ...
    echo -ne '\033]0;CC-TSX-DEV - Team 1\007'
    PROMPT_COMMAND='printf \"\033]0;CC-TSX-DEV - Team 1\007\"'
    ...
    clear
    echo '══════════════════════════════════════════════════════'
    echo '  Claude Code Session - Team 1'
    echo '══════════════════════════════════════════════════════'
    echo ''
    echo \"  Project: \$(pwd)\"
    echo ''
