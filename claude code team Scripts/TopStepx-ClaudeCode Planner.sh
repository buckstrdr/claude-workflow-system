#!/bin/bash
# Simplified Claude Code Launcher - Planner
...
xterm -xrm 'XTerm.vt100.allowTitleOps: false' -T "CC-TSX-DEV - Planner" -e bash -c "
    ...
    echo -ne '\033]0;CC-TSX-DEV - Planner\007'
    PROMPT_COMMAND='printf \"\033]0;CC-TSX-DEV - Planner\007\"'
    ...
    clear
    echo '══════════════════════════════════════════════════════'
    echo '  Claude Code Session - Planner'
    echo '══════════════════════════════════════════════════════'
    echo ''
    echo \"  Project: \$(pwd)\"
    echo ''
