...
- `CLAUDE.md` - Core workflow and philosophy
- `AGENTS.md` - Agent definitions and canonical config
...
- **34 skills**: startup, status, logs, find, validator, karen, pragmatist, api, asyncio, clean, debug, fastapi, pydantic, python, react, restart, smoke, start, strategy, sync, tailwind, test, trading, triage, typescript, websocket, zustand, github, spec, verify-complete, e2e-verify, adr, gates, session-end
- **Superpowers plugin**: Loaded and active
- **13+ git hooks**:
